...
var _componentsBrowseJsx = require('./components/Browse.jsx');

var _componentsBrowseJsx2 = _interopRequireDefault(_componentsBrowseJsx);
...
_reactDom2['default'].render(_react2['default'].createElement(_componentsBrowseJsx2['default'], { requests: _sharedBootstrapData2['default'].getJSON('requests') }), document.getElementById('browse'));

},{"../shared/BootstrapData":6,"./components/Browse.jsx":3,"react":179,"react-dom":23}],2:[function(require,module,exports){
'use strict';
...
var _sharedComponentsRequestJsx = require('../../shared/components/Request.jsx');

var _sharedComponentsRequestJsx2 = _interopRequireDefault(_sharedComponentsRequestJsx);
...
var Browse = (function (_Component) {
  ...
  Browse.prototype.render = function render() {
          ...
          _react2['default'].createElement(
            ...
            this.props.requests.map(function (request, i) {
              return _react2['default'].createElement(
                'div',
                { className: 'request' },
                _react2['default'].createElement(_sharedComponentsRequestJsx2['default'], {
                  key: 'request_' + i,
...
},{"../../navigation/components/SubNav.jsx":5,"../../shared/components/Request.jsx":7,"react":179}],4:[function(require,module,exports){
'use strict';
...
},{"classnames":21,"react":179}],5:[function(require,module,exports){
'use strict';
...
},{"./NavItem.jsx":4,"react":179}],6:[function(require,module,exports){
'use strict';
...
var Request = (function (_Component) {
  ...
  Request.prototype.sendEmail = function sendEmail() {
  ...
  Request.prototype.render = function render() {
    ...
    if (!this.props.hideOfferHelp) {
      offerHelpContainer = _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'a',
          { href: '/dashboard/offerhelp/' + this.props.requestId, className: 'btn btn-primary btn-lg btn-block' },
          'Offer Help'
        )
      );
    }
